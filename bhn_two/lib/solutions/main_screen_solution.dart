...
import 'package:bhn_two/solutions/recipe_card_solution.dart';
...
class _MainScreenSolutionState extends State<MainScreenSolution> {
  List<Lasagna> lasagnas = [
    ...
    Lasagna("Lasagna spinach", "Creamy green version of lasagna, excellent as a veggi alternative to bolognese.",
        image: "lib/assets/images/spinach_lasagna.jpg"),
    Lasagna("Lasagna salmon", "A modern interpretation of the italian classic, delicious with salmon.",
        image: "lib/assets/images/salmon_lasagna.jpg"),
    ...
    return ListView.builder(
      itemBuilder: (context, index) {
        return GestureDetector(
          child: RecipeCardSolution(lasagnas[index]),
          onTap: () {
